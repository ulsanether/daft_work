...
void step_up(int axis) {
  ...
  switch (axis) {
    case 0:  //0.2
      set_val += (Move_high / 5);
      stepper.runToNewPosition(Move_high / 5);  //
      Serial.println("가");
      break;
    case 1:  //1mm  //250 1mm  
      stepper.runToNewPosition(Move_high * 2);  //1
      set_val += (Move_high * 2);
      Serial.println("나");
      break;
    case 2:  //위로 5mm
      Serial.println("다");
      set_val += (Move_high * 4);
      stepper.runToNewPosition(Move_high * 4);

      break;
    case 3:  //10mm
set_val += (Move_high * 20);
...
void step_down(int axis) {
  ...
  switch (axis) {
    case 0:  //아래로 0.2mm
      set_val -= (Move_low / 5);
      stepper.runToNewPosition(Move_low / 5);  //0.2
    ...
    case 2:  //아래로 5mm
      ...
      stepper.runToNewPosition(Move_low * 4);  //2mm
   set_val -= (Move_low * 4);
      break;
    case 3:  //아래로 10mm
